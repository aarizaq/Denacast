...
private:
   IInterfaceTable *ift;
   IPvXAddress myAddr;
   bool addrIsLocal(const IPvXAddress &add);
...
public:
    ...
    void sendDown(cPacket *appData, const IPvXAddress& srcAddr, ushort srcPort, const IPvXAddress& destAddr, ushort destPort,
